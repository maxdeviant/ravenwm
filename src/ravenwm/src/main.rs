...
async fn run() {
    ...
    let ipc_server = ipc::Server::bind(&socket).await;
                ...
                match response_type {
                    ...
                    xcb::CONFIGURE_REQUEST => {
                        ...
                        if configure_request.value_mask() & (xcb::CONFIG_WINDOW_X as u16) == 0 {
                            values
                                .push((xcb::CONFIG_WINDOW_X as u16, configure_request.x() as u32));
                        }

                        if configure_request.value_mask() & (xcb::CONFIG_WINDOW_Y as u16) == 0 {
                            values
                                .push((xcb::CONFIG_WINDOW_Y as u16, configure_request.y() as u32));
                        }
                        ...
                        if configure_request.value_mask() & (xcb::CONFIG_WINDOW_STACK_MODE as u16)
                            == 0
                        {
                            values.push((
